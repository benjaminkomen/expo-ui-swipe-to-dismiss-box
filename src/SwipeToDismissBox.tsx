...
import { type ModifierConfig, createViewModifierEventListener } from './utils';
...
const SwipeToDismissBoxNativeView: React.ComponentType<NativeSwipeToDismissBoxProps> =
  requireNativeView('ExpoUISwipeToDismissBox', 'SwipeToDismissBoxView');
 ...
 *
 * @see https://developer.android.com/develop/ui/compose/touch-input/user-interactions/swipe-to-dismiss
 * @platform android
 */
